...
namespace omitsis\rest_api\online_pricing_local_currency;

defined( 'ABSPATH' ) || exit;

/**
 * The function `get_data_api_endpoint` retrieves data from a REST API endpoint based on the provided
 * year, type, and country parameters.
 *
