...
$LatestContents = get_query_latest_content($number_of_items); ?>

<section class="latest-content-module tm-module<?php echo esc_attr($container_style); ?>">

    <?php if ($title) { ?>
        <h2 class="new-module-label"><?php echo esc_html($title); ?></h2>
    <?php } ?>

    <div class="latest-content-module__inner">
        <?php \tamarind_base\print_slider($LatestContents, 'default', 'readmore', $item_style); ?>
    </div>
