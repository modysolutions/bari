				...
				<table id="acui_options_wrapper" class="form-table">
					...
					<tr id="acui_send_email_wrapper" class="form-field">
						...
						<td>
							<p id="sends_email_wrapper">
								<?php ACUIHTML()->checkbox( array( 'name' => 'sends_email', 'label' => sprintf( __( 'Do you wish to send an email from this plugin with credentials and other data? <a href="%s">(email template found here)</a>', 'import-users-from-csv-with-meta' ), admin_url( 'admin.php?page=acui&tab=mail-options' ) ), 'current' => 'yes', 'compare_value' => $settings->get( 'sends_email' ) ) ); ?>
							</p>
					...
					<tr class="form-field form-required">
						...
						<td>
							...
							<p class="description"><?php echo sprintf( __( 'Please, <a href="%s">read the documentation</a> before activating this option', 'import-users-from-csv-with-meta' ), admin_url( 'admin.php?page=acui&tab=doc#force_user_reset_password' ) ); ?></p>
						</td>
					</tr>
