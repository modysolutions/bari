...
class ACUI_Import{
    ...
    function show(){
        ...
        echo '<h1>Tamarind Import users</h1>';
    ...
    function manage_file_upload( $path_to_file ){
        ...
        if( validate_file( $path_to_file ) !== 0 ){
            ...
            echo sprintf( __( 'Reload or try <a href="%s">a new import here</a>', 'import-users-from-csv-with-meta' ), get_admin_url( null, 'admin.php?page=acui&tab=homepage' ) );
            return false;
        } 
