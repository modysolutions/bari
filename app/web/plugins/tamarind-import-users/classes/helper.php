...
class ACUI_Helper{
    ...
    function print_end_of_process(){
        ?>
        <br/>
        <p><?php printf( __( 'Process finished you can go <a href="%s">here to see results</a> or you can do <a href="%s">a new import</a>.', 'import-users-from-csv-with-meta' ), get_admin_url( null, 'users.php' ), get_admin_url( null, 'admin.php?page=acui&tab=homepage' ) ); ?></p>
        <?php
    }
