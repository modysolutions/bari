...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="stylesheet" href="/wp-content/plugins/tamarind-pdfs/pdf-viewer/web/viewer.css">

<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="locale/locale.properties">
<script src="/wp-content/plugins/tamarind-pdfs/pdf-viewer/build/pdf.js"></script>

  <script src="/wp-content/plugins/tamarind-pdfs/pdf-viewer/web/viewer.js"></script>
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="download" class="toolbarButton hiddenMediumView download-reports" title="Download" tabindex="34" data-l10n-id="download">
                  <span data-l10n-id="download_label">Download</span>
                </button>
