...
<?php $add_payment_method_link = get_option_menu_link( 'account_details_add_payment_methods' ); ?>

<?php // echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>

<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<a class="button" href="<?php echo esc_url( $add_payment_method_link['link'] ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
<?php endif; ?>
