<?php
/**
 * Template for Round-ups module sidebar.
 *
...
$title_module    = __( 'Round-ups', 'tamarind-base' );
$number_of_items = 5;
...
ksort( $cache_args );
$cache_key = 'sidebar_alerts_recents_roundups_' . md5( serialize( $cache_args ) );
$cache_group = 'alerts';
...
<section class="round-ups-sidebar tm-sidebar-module <?php echo esc_attr( $container_style ); ?>">
    ...
    <p style="margin-top:20px">
        <a href="<?php echo esc_url( get_term_link( 'alerts', 'content_types' ) ); ?>">
